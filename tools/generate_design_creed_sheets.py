...
def load_fonts():
    try:
        fonts = {
            "large_title": ImageFont.truetype(FONT_BOLD_PATH, 42),
            "card_title": ImageFont.truetype(FONT_BOLD_PATH, 26),
            "box_header": ImageFont.truetype(FONT_BOLD_PATH, 22),
            "body": ImageFont.truetype(FONT_PATH, 18),
            "body_bold": ImageFont.truetype(FONT_BOLD_PATH, 18),
            "desc": ImageFont.truetype(FONT_PATH, 18),
...
def generate_specialty_design():
    ...
    desc_lines = [
        ...
        "2. 差异化策略：根据五个地块不同的权属、规模 and 痛点，定制了适老共享、工业活化、历史缝合等差异化方案，以点带面激活街区。"
    ]
    y_desc = 295
    ...
    spec_lines = [
        ...
        "• 石油公司地块 (1.30ha)：容积率≤0.2，建筑密度≤15%，绿地率≥85%，限高6m。"
    ]
    y_spec = 720
