    ...
    "a3_sheets": [
        {
            ...
            "prompt": (
                "A3 urban planning competition infographic, government market residents virtuous cycle, "
                "policy flow arrows, clean white background, red teal orange navy palette, "
                "professional masterplan diagram, no small text"
            ),
        },
        {
            ...
            "prompt": (
                "A3 urban policy tools matrix infographic, fiscal subsidy tax relief rent sharing PPP "
                "community fund performance review, clean grid, urban planning board style, no small text"
            ),
        },
        {
            ...
            "prompt": (
                "A3 market operation revenue return infographic, urban renewal, business mix, footfall, "
                "rent revenue, reinvestment loop, professional planning diagram, no small text"
            ),
        },
        {
            ...
            "prompt": (
                "A3 resident benefits governance feedback infographic, jobs public service public space "
                "community fund participatory governance, urban renewal planning style, no small text"
            ),
        },
    ],
}
...
def build_policy_prompt() -> str:
    return (
        ...
        "loop_nodes、policy_tools、a3_sheets。a3_sheets必须为4张A3小图纸，并为每张提供"
        "file、title、caption、prompt。"
    )
