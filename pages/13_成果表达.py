    ...
    with col_ctrl:
        ...
        default_desc = {
            "现状区位图": [
                ...
                "2. 规划范围：规划研究范围东至伊通河、西至亚泰大街、南至长通路、北至京哈铁路，总规划研究面积约160公顷。包含多个重点更新单元。",
            ...
            "空间结构规划图": [
                "1. 规划结构：形成“一核、双轴、多点联动”的总体更新规划结构。一核指历史文化共振核，双轴为站城联动轴与生态延伸轴。",
                "2. 站城联动：打通长春站至伪满皇宫的空间轴线，利用高品质慢行商业街与视觉廊道建立两者的物理与文化强关联。",
                "3. 节点触媒：以重点更新单元形成的活力节点为针灸触点，激活周边消极的街区本底，促进历史风貌区与现代化城市的无缝衔接。"
            ],
            "用地规划图": [
