...
QgsVectorFileWriter.writeAsVectorFormat(
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "Changchun_POI_Real.csv",
        "accept": [".csv", ".xlsx"],
...
print(f"获取了 {len(all_pois)} 个 POI")''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "Changchun_Traffic_Real.csv",
        "accept": [".csv", ".xlsx"],
...
print("照片整理完成！")''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "CV_NLP_RawData.csv",
        "accept": [".csv", ".xlsx"],
...
df.to_csv("data/csv/CV_NLP_RawData.csv", index=False, encoding="utf-8-sig")''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "GVI_Results_Analysis.csv",
        "accept": [".csv", ".xlsx"],
...
print(f"处理完成，共 {len(results)} 个采样点")''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "Changchun_Precise_Points.xlsx",
        "accept": [".csv", ".xlsx"],
...
print(f"构建了 {len(knowledge_base)} 个知识块")''',
    ...
    # ============================================================
    {
        ...
        "target_path": CSV_DIR / "Building_Years.csv",
        "accept": [".csv", ".xlsx"],
...
df = fetcher.fetch_all()''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "Traffic_Flow.csv",
        "accept": [".csv", ".xlsx"],
...
for road in roads:
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "House_Prices.csv",
        "accept": [".csv", ".xlsx"],
...
df.to_csv("data/csv/House_Prices.csv", index=False, encoding="utf-8-sig")''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "Land_Prices.csv",
        "accept": [".csv", ".xlsx"],
...
python scripts/fetch_supplementary_data.py --history''',
    ...
    },
    {
        ...
        "target_path": CSV_DIR / "Sunshine_Annual.csv",
        "accept": [".csv", ".xlsx"],
