...
CITY_DESIGN_STAGES = [
    ...
    {"code": "01", "title": "数据准备与任务解读", "focus": "上传项目原始数据、查阅获取教程、锁定研究范围与任务要求。"},
    {"code": "02", "title": "资料收集与现场调研", "focus": "汇总空间数据资产、语义萃取、街景核验和物理底座管理。"},
    {"code": "03", "title": "资料收集与现场调研", "focus": "汇总空间数据资产、语义萃取、街景核验和物理底座管理。"},
    {"code": "04", "title": "现状分析与问题诊断", "focus": "3D 全息底座分析、MPI 潜力评估、地块雷达诊断和 AI 问题报告。"},
    {"code": "05", "title": "现状分析与问题诊断", "focus": "3D 全息底座分析、MPI 潜力评估、地块雷达诊断和 AI 问题报告。"},
    ...
    {"code": "09", "title": "专项系统设计", "focus": "深化交通、公共空间、建筑形态、风貌与立面等专项系统。"},
...
STAGE_RESOURCE_MAP = {
    "00": {
        ...
        "resources": [
            ("数据上传中心", "/数据准备与任务解读?sub=数据上传中心"),
            ("数据获取教程", "/数据准备与任务解读?sub=数据获取教程"),
            ("数据质量检查", "/数据准备与任务解读?sub=数据质量检查"),
        ],
    ...
    "01": {
        ...
        "resources": [
            ("项目概况与任务要求", "/数据准备与任务解读?sub=项目概况与任务要求"),
            ("首页研究范围底图", "/"),
        ],
    ...
    "02": {
        ...
        "resources": [
            ("空间数据资产管理", "/资料收集与现场调研?sub=空间数据资产管理"),
            ("语义萃取引擎", "/资料收集与现场调研?sub=语义萃取引擎"),
        ],
    ...
    "04": {
        ...
        "resources": [
            ("3D现状全息底座", "/现状分析与问题诊断?sub=3D现状全息底座"),
        ],
    ...
    "05": {
        ...
        "resources": [
            ("MPI 更新潜力评估", "/现状分析与问题诊断?sub=MPI更新潜力评估"),
            ("地块雷达诊断", "/现状分析与问题诊断?sub=地块雷达诊断"),
            ("AI 前期诊断报告", "/现状分析与问题诊断?sub=AI前期诊断报告"),
        ],
    ...
    "06": {
        ...
        "resources": [
            ("设计理念提炼", "/设计策略?sub=阶段三：设计理念"),
            ("任务书目标依据", "/数据准备与任务解读?sub=策略语义萃取"),
        ],
    ...
    "07": {
        ...
        "resources": [
            ("案例对标分析", "/设计策略?sub=阶段二：方案借鉴"),
            ("问题-策略对应", "/设计策略?sub=阶段四：问题-策略对应"),
            ("动态共识雷达", "/设计策略?sub=动态共识雷达"),
        ],
    ...
    "09": {
        ...
        "resources": [
            ("3D 图层诊断", "/现状分析与问题诊断?sub=3D现状全息底座"),
            ("地下管网 X-Ray", "/成果表达?sub=更新设计大地图"),
        ],
    ...
    "11": {
        ...
        "resources": [
            ("留改拆总图", "/成果表达?sub=更新设计大地图"),
            ("空间成果方案", "/设计策略?sub=空间成果方案"),
        ],
    ...
    "12": {
        ...
        "resources": [
            ("规划文本成果", "/成果表达?sub=规划文本成果"),
            ("最终规划导则", "/设计策略?sub=空间成果方案"),
        ],
    ...
    "13": {
        ...
        "resources": [
            ("图纸提示词助手", "/设计策略?sub=图纸提示词助手"),
            ("重点地块效果图", "/成果表达?sub=重点地块效果图"),
            ("Word 成果导出", "/成果表达?sub=规划文本成果"),
        ],
...
STAGE_MODULE_MAP = {
    "00": [
        {"title": "数据上传中心", "href": "/数据准备与任务解读?sub=数据上传中心", "desc": "上传空间、POI、街景、文本等各类原始数据。", "kind": "数据模块"},
        {"title": "数据获取教程", "href": "/数据准备与任务解读?sub=数据获取教程", "desc": "查看各类数据的详细获取方式和格式要求。", "kind": "教程模块"},
        {"title": "数据质量检查", "href": "/数据准备与任务解读?sub=数据质量检查", "desc": "检查已上传数据的完整性和质量。", "kind": "检查模块"},
    ],
    "01": [
        {"title": "项目概况与任务要求", "href": "/数据准备与任务解读?sub=项目概况与任务要求", "desc": "锁定研究边界、设计深度和核心任务。", "kind": "任务模块"},
    ],
    "02": [
        {"title": "语义萃取引擎", "href": "/资料收集与现场调研?sub=语义萃取引擎", "desc": "政策、任务书和开题资料批量提取。", "kind": "语义模块"},
        {"title": "空间数据资产管理", "href": "/资料收集与现场调研?sub=空间数据资产管理", "desc": "边界、建筑、POI、街景和规划图层挂载。", "kind": "数据模块"},
        {"title": "固定制图模板", "href": "/资料收集与现场调研?sub=固定制图模板", "desc": "上传底图、红线、地块和图框资产。", "kind": "模板模块"},
    ],
    "03": [
        {"title": "现场调研街景样本库", "href": "/资料收集与现场调研?sub=现场调研", "desc": "读取 streetview 文件夹中的调研点街景图。", "kind": "调研模块"},
    ],
    "04": [
        {"title": "3D 现状全息底座", "href": "/现状分析与问题诊断?sub=3D现状全息底座", "desc": "用地、建筑、交通、POI 和街景指标综合诊断。", "kind": "分析模块"},
    ],
    "05": [
        {"title": "MPI 更新潜力评估", "href": "/现状分析与问题诊断?sub=MPI更新潜力评估", "desc": "AHP 权重和更新潜力排序。", "kind": "评价模块"},
        {"title": "地块雷达诊断", "href": "/现状分析与问题诊断?sub=地块雷达诊断", "desc": "MPI、POI、GVI 与地块雷达评价。", "kind": "诊断模块"},
        {"title": "AI 前期诊断报告", "href": "/现状分析与问题诊断?sub=AI前期诊断报告", "desc": "把指标诊断转成问题清单和报告。", "kind": "报告模块"},
    ],
    "06": [
        {"title": "设计理念与目标定位", "href": _module_url("设计策略", "阶段三：设计理念"), "desc": "由问题与案例提炼愿景、目标和定位。", "kind": "目标模块"},
        {"title": "目标依据语义库", "href": _module_url("资料收集与现场调研", "策略语义萃取"), "desc": "任务书和政策条款作为目标依据。", "kind": "依据模块"},
    ],
    "07": [
        {"title": "问题-策略对应推演", "href": _module_url("设计策略", "阶段四：问题-策略对应"), "desc": "形成问题、目标、策略和主体诉求对照。", "kind": "策略模块"},
        {"title": "案例对标分析", "href": _module_url("设计策略", "阶段二：方案借鉴"), "desc": "抽取开题案例并转成可借鉴策略。", "kind": "案例模块"},
        {"title": "动态共识雷达", "href": _module_url("设计策略", "动态共识雷达"), "desc": "查看多主体协商后的共识度结果。", "kind": "协商模块"},
    ],
    "08": [
        {"title": "概念总平面图生形", "href": _module_url("AIGC设计推演", "概念总平面图生形"), "desc": "生成总体结构、总平面和空间意向。", "kind": "总图模块"},
        {"title": "更新设计大地图", "href": _module_url("成果表达", "更新设计大地图"), "desc": "把总体方案叠加到成果地图。", "kind": "成果模块"},
    ],
    "09": [
        {"title": "专项系统空间叠合", "href": _module_url("现状分析与问题诊断", "3D现状全息底座"), "desc": "交通、公共空间、建筑形态/风貌与立面图层叠合。", "kind": "专项模块"},
        {"title": "更新设计大地图", "href": _module_url("成果表达", "更新设计大地图"), "desc": "承接专项系统图和留改拆图层。", "kind": "成果模块"},
    ],
    "10": [
        ...
        {"title": "重点地块效果图", "href": _module_url("成果表达", "重点地块效果图"), "desc": "沉淀重点节点效果图集。", "kind": "图集模块"},
    ],
    "11": [
        {"title": "实施路径与留改拆总图", "href": _module_url("成果表达", "更新设计大地图"), "desc": "将保护、修缮、改造和拆建策略落到图层。", "kind": "实施模块"},
        {"title": "空间成果方案", "href": _module_url("设计策略", "空间成果方案"), "desc": "汇总实施路径、规划导则和红头任务。", "kind": "方案模块"},
    ],
    "12": [
        {"title": "规划文本成果", "href": _module_url("成果表达", "规划文本成果"), "desc": "导则总则、管控条文和 Word 成果导出。", "kind": "导则模块"},
        {"title": "最终规划导则推演", "href": _module_url("设计策略", "空间成果方案"), "desc": "把空间策略转成可交付导则文本。", "kind": "文本模块"},
    ],
    "13": [
        {"title": "图纸提示词助手", "href": _module_url("设计策略", "图纸提示词助手"), "desc": "面向成果图纸的提示词组织与优化。", "kind": "表达模块"},
        {"title": "重点地块效果图集", "href": _module_url("成果表达", "重点地块效果图"), "desc": "管理和展示重点地块成果图。", "kind": "图集模块"},
        {"title": "Word 成果导出", "href": _module_url("成果表达", "规划文本成果"), "desc": "导出规划文本、导则和说明文件。", "kind": "交付模块"},
    ],
}
...
def stage_primary_href(stage_code):
    ...
    from src.config.paths import PAGE_ROUTES
    return PAGE_ROUTES.get(str(stage_code), "#")
...
def resolve_subpage_value(options, default_index=0, aliases=None):
    idx = resolve_subpage_option(options, default_index, aliases)
    return options[idx] if idx < len(options) else options[default_index]
